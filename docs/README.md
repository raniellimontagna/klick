...
Esta documentação foi estruturada para:
- **Não repetir informações** entre documentos
- **Facilitar contexto** para assistentes de IA
- **Modularidade** - cada arquivo é auto-contido

Ao editar o projeto, consulte o documento relevante para contexto completo.
