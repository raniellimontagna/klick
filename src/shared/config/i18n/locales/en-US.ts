export const enUS = {
  ...
  cubeViewer: {
    badge: '3D workspace',
    overview: {
      title: 'Cube workspace',
      scramble: 'Active scramble',
      emptyScramble: 'Generate a scramble to begin.',
      status: 'Scene status',
      progress: 'Playback progress',
      progressValue: 'Step {current} of {total}',
      progressEmpty: 'No steps loaded yet.',
      ...
      reducedMotion: 'Reduced motion is enabled, so autoplay waits for your manual input.',
      sound: 'Audio feedback',
      soundOn: 'Sound on',
      soundOff: 'Sound off',
      motion: 'Motion',
      controlTitle: 'Session readout',
      controlDescription:
        'Playback, history, and quick adjustments stay grouped together for focused cube review.',
    },
    workspace: {
      title: 'Cube desk',
      description:
    ...
    history: {
      title: 'History',
      description: 'Your manual moves appear here in chronological order.',
      empty: 'No manual moves recorded yet.',
      count: '{count} recorded moves',
    },
    status: {
      scrambling: 'Applying scramble',
      playing: 'Playback running',
      animating: 'Executing manual move',
  ...
  trainingLab: {
    ...
    labels: {
      ...
      trackCompletion: 'Drill completion',
      nextStep: 'Next step',
    ...
    progress: {
      ...
      overallSummary: '{attempts} of {target} attempts completed across the lab.',
      drillsCompleted: '{completed} of {total} drills complete.',
      completion: '{percent}% of the track completed.',
    },
    overview: {
      trackPosition: 'Track {current} of {total}',
      overallProgress: 'Overall progress',
      currentDrill: 'Focus drill',
      nextStep: 'Next step',
      finishCurrent: 'Complete {count} more attempts on this drill before moving on.',
      goToDrill: 'After that, move to {drill} in the {track} track.',
      allComplete: 'The current lab targets are already complete.',
    },
    nextStep: {
      activeDrill: 'Stay on the current drill',
      keepGoing: '{remaining} attempts left to hit this drill target.',
      trackCompleteTitle: 'Track complete for now',
      trackComplete: 'All active drills in this track have reached their current target.',
    },
    confidence: {
      starting: 'Warming up',
  ...
  tutorialGuide: {
    ...
    progress: {
      ...
      overall: '{current} of {total} lessons covered',
      completion: '{percent}% of the journey completed.',
    },
    overview: {
      methodProgress: 'Method progress',
      methodProgressValue: '{completed} of {total} lessons covered',
      currentStage: 'Active stage',
      nextLesson: 'Next lesson',
      nextLessonValue: '{stage}: {lesson}',
      stageProgress: 'Stage progress',
      allComplete: 'Journey complete for now.',
    },
    journey: {
      title: 'Guided journey',
      nextStep: 'Next step',
      finished: 'Journey complete for now',
    },
    layout: {
      roadmapTitle: 'Method roadmap',
      roadmapDescription: 'Pick a stage to review or continue from the current lesson.',
      lessonListTitle: 'Stage lessons',
    },
    method: {
