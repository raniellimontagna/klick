...
import { ScrambleGuideModal } from '@/shared/components/scramble-guide-modal/ScrambleGuideModal';
import { useScrambleGuideModal } from '@/shared/components/scramble-guide-modal/useScrambleGuideModal';
